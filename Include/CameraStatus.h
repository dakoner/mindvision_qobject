...
// 自定义
#define CAMERA_MV_SSR_COMM_ERROR					      0xF000 ///< \~chinese SSR通讯错误 \~english SSR communication error
#define CAMERA_MV_SSR_TRAIN_ERROR					      0xF001 ///< \~chinese SSR训练错误 \~english SSR training error
